/*! jQuery v1.11.1 -css,-css/addGetHookIf,-css/curCSS,-css/defaultDisplay,-css/hiddenVisibleSelectors,-css/support,-css/swap,-css/var/cssExpand,-css/var/isHidden,-css/var/rmargin,-css/var/rnumnonpx,-effects,-effects/Tween,-effects/animatedSelector,-effects/support,-dimensions,-offset,-deprecated,-event-alias,-wrap | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license */ ! function (a, b) {
    ...
    var S = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
        T = m.access = function (a, b, c, d, e, f, g) {
            var h = 0,
                i = a.length,
                j = null == c;
            if ("object" === m.type(c)) {
    ...
    m.event = {
        ...
        add: function (a, b, c, d, e) {
            ...
            if (r) {
                ...
                while (h--) f = Z.exec(b[h]) || [], o = q = f[1], p = (f[2] || "").split(".").sort(), o && (j = m.event.special[o] || {}, o = (e ? j.delegateType : j.bindType) || o, j = m.event.special[o] || {}, l = m.extend({
                    type: o,
                    origType: q,
                    data: d,
                    handler: c,
        ...
        trigger: function (b, c, d, e) {
            ...
            if (h = l = d = d || y, 3 !== d.nodeType && 8 !== d.nodeType && !Y.test(p + m.event.triggered) && (p.indexOf(".") >= 0 && (q = p.split("."), p = q.shift(), q.sort()), g = p.indexOf(":") < 0 && "on" + p, b = b[m.expando] ? b : new m.Event(p, "object" == typeof b && b), b.isTrigger = e ? 2 : 3, b.namespace = q.join("."), b.namespace_re = b.namespace ? new RegExp("(^|\\.)" + q.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, b.result = void 0, b.target || (b.target = d), c = null == c ? [b] : m.makeArray(c, [b]), k = m.event.special[p] || {}, e || !k.trigger || k.trigger.apply(d, c) !== !1)) {
                if (!e && !k.noBubble && !m.isWindow(d)) {
                    for (i = k.delegateType || p, Y.test(i + p) || (h = h.parentNode); h; h = h.parentNode) o.push(h), l = h;
        ...
        fix: function (a) {
            ...
            var b, c, d, e = a.type,
                f = a,
                g = this.fixHooks[e];
            g || (this.fixHooks[e] = g = X.test(e) ? this.mouseHooks : W.test(e) ? this.keyHooks : {}), d = g.props ? this.props.concat(g.props) : this.props, a = new m.Event(f), b = d.length;
        ...
        return this instanceof m.Event ? (a && a.type ? (this.originalEvent = a, this.type = a.type, this.isDefaultPrevented = a.defaultPrevented || void 0 === a.defaultPrevented && a.returnValue === !1 ? $ : _) : this.type = a, b && m.extend(this, b), this.timeStamp = a && a.timeStamp || m.now(), void(this[m.expando] = !0)) : new m.Event(a, b)
    }, m.Event.prototype = {
        ...
        preventDefault: function () {
            ...
            this.isDefaultPrevented = $, a && (a.preventDefault ? a.preventDefault() : a.returnValue = !1)
        },
        stopPropagation: function () {
            var a = this.originalEvent;
            this.isPropagationStopped = $, a && (a.stopPropagation && a.stopPropagation(), a.cancelBubble = !0)
        },
        ...
        setup: function () {
            return V.test(this.nodeName) ? (("checkbox" === this.type || "radio" === this.type) && (m.event.add(this, "propertychange._change", function (a) {
                "checked" === a.originalEvent.propertyName && (this._just_changed = !0)
            }), m.event.add(this, "click._change", function (a) {
                this._just_changed && !a.isTrigger && (this._just_changed = !1), m.event.simulate("change", this, a, !0)
            })), !1) : void m.event.add(this, "beforeactivate._change", function (a) {
                var b = a.target;
                V.test(b.nodeName) && !m._data(b, "changeBubbles") && (m.event.add(b, "change._change", function (a) {
        ...
        teardown: function () {
            return m.event.remove(this, "._change"), !V.test(this.nodeName)
        }
    ...
    function sb(a, b) {
        ...
        if (!f)
            for (f = [], c = a.childNodes || a; null != (d = c[e]); e++) !b || m.nodeName(d, b) ? f.push(d) : m.merge(f, sb(d, b));
        return void 0 === b || b && m.nodeName(a, b) ? m.merge([a], f) : f
    }

    function tb(a) {
        U.test(a.type) && (a.defaultChecked = a.checked)
    }
    ...
    m.extend({
            clone: function (a, b, c) {
                ...
                if (k.html5Clone || m.isXMLDoc(a) || !eb.test("<" + a.nodeName + ">") ? f = a.cloneNode(!0) : (rb.innerHTML = a.outerHTML, rb.removeChild(f = rb.firstChild)), !(k.noCloneEvent && k.noCloneChecked || 1 !== a.nodeType && 11 !== a.nodeType || m.isXMLDoc(a)))
                    for (d = sb(f), h = sb(a), g = 0; null != (e = h[g]); ++g) d[g] && zb(e, d[g]);
                if (b)
                    if (c)
                        for (h = h || sb(a), d = d || sb(f), g = 0; null != (e = h[g]); g++) yb(e, d[g]);
                    else yb(a, f);
                return d = sb(f, "script"), d.length > 0 && xb(d, !i && sb(a, "script")), d = h = e = null, f
            },
            buildFragment: function (a, b, c, d) {
                for (var e, f, g, h, i, j, l, n = a.length, o = bb(b), p = [], q = 0; n > q; q++)
                    if (f = a[q], f || 0 === f)
                        if ("object" === m.type(f)) m.merge(p, f.nodeType ? [f] : f);
                        else if (jb.test(f)) {
                    h = h || o.appendChild(b.createElement("div")), i = (hb.exec(f) || ["", ""])[1].toLowerCase(), l = pb[i] || pb._default, h.innerHTML = l[1] + f.replace(gb, "<$1></$2>") + l[2], e = l[0];
                    while (e--) h = h.lastChild;
                    if (!k.leadingWhitespace && fb.test(f) && p.push(b.createTextNode(fb.exec(f)[0])), !k.tbody) {
                        f = "table" !== i || ib.test(f) ? "<table>" !== l[1] || ib.test(f) ? 0 : h : h.firstChild, e = f && f.childNodes.length;
                ...
                h && o.removeChild(h), k.appendChecked || m.grep(sb(p, "input"), tb), q = 0;
                while (f = p[q++])
                    if ((!d || -1 === m.inArray(f, d)) && (g = m.contains(f.ownerDocument, f), h = sb(o.appendChild(f), "script"), g && xb(h), c)) {
                        e = 0;
                        while (f = h[e++]) mb.test(f.type || "") && c.push(f)
                    }
                return h = null, o
            },
            ...
            remove: function (a, b) {
                for (var c, d = a ? m.filter(a, this) : this, e = 0; null != (c = d[e]); e++) b || 1 !== c.nodeType || m.cleanData(sb(c)), c.parentNode && (b && m.contains(c.ownerDocument, c) && xb(sb(c, "script")), c.parentNode.removeChild(c));
                return this
            },
            empty: function () {
                for (var a, b = 0; null != (a = this[b]); b++) {
                    1 === a.nodeType && m.cleanData(sb(a, !1));
            ...
            html: function (a) {
                return T(this, function (a) {
                    var b = this[0] || {},
                        c = 0,
                        d = this.length;
                    if (void 0 === a) return 1 === b.nodeType ? b.innerHTML.replace(db, "") : void 0;
                    if (!("string" != typeof a || kb.test(a) || !k.htmlSerialize && eb.test(a) || !k.leadingWhitespace && fb.test(a) || pb[(hb.exec(a) || ["", ""])[1].toLowerCase()])) {
                        a = a.replace(gb, "<$1></$2>");
                        try {
                            for (; d > c; c++) b = this[c] || {}, 1 === b.nodeType && (m.cleanData(sb(b, !1)), b.innerHTML = a);
                            b = 0
                        } catch (e) {}
                    }
            ...
            replaceWith: function () {
                ...
                return this.domManip(arguments, function (b) {
                    a = this.parentNode, m.cleanData(sb(this)), a && a.replaceChild(b, this)
            ...
            domManip: function (a, b) {
                ...
                var c, d, f, g, h, i, j = 0,
                    ...
                    p = a[0],
                    q = m.isFunction(p);
                if (q || l > 1 && "string" == typeof p && !k.checkClone && lb.test(p)) return this.each(function (c) {
                    var d = n.eq(c);
                    q && (a[0] = p.call(this, c, d.html())), d.domManip(a, b)
                });
                if (l && (i = m.buildFragment(a, this[0].ownerDocument, !1, this), c = i.firstChild, 1 === i.childNodes.length && (i = c), c)) {
                    for (g = m.map(sb(i, "script"), vb), f = g.length; l > j; j++) d = i, j !== o && (d = m.clone(d, !0, !0), f && m.merge(g, sb(d, "script"))), b.call(this[j], d, j);
                    if (f)
    ...
    m.fn.extend({
        val: function (a) {
            var b, c, d, e = this[0]; {
                ...
                if (e) return b = m.valHooks[e.type] || m.valHooks[e.nodeName.toLowerCase()], b && "get" in b && void 0 !== (c = b.get(e, "value")) ? c : (c = e.value, "string" == typeof c ? c.replace(Ab, "") : null == c ? "" : c)
            }
        }
    }), m.extend({
        valHooks: {
    ...
    m.fn.extend({
        attr: function (a, b) {
            return T(this, m.attr, a, b, arguments.length > 1)
        },
        ...
        attr: function (a, b, c) {
            var d, e, f = a.nodeType;
            if (a && 3 !== f && 8 !== f && 2 !== f) return typeof a.getAttribute === K ? m.prop(a, b, c) : (1 === f && m.isXMLDoc(a) || (b = b.toLowerCase(), d = m.attrHooks[b] || (m.expr.match.bool.test(b) ? Cb : Bb)), void 0 === c ? d && "get" in d && null !== (e = d.get(a, b)) ? e : (e = m.find.attr(a, b), null == e ? void 0 : e) : null !== c ? d && "set" in d && void 0 !== (e = d.set(a, c, b)) ? e : (a.setAttribute(b, c + ""), c) : void m.removeAttr(a, b))
        },
        removeAttr: function (a, b) {
            var c, d, e = 0,
                f = b && b.match(E);
            if (f && 1 === a.nodeType)
                while (c = f[e++]) d = m.propFix[c] || c, m.expr.match.bool.test(c) ? Gb && Fb || !Eb.test(c) ? a[d] = !1 : a[m.camelCase("default-" + c)] = a[d] = !1 : m.attr(a, c, ""), a.removeAttribute(Fb ? c : d)
        },
        attrHooks: {
            type: {
                set: function (a, b) {
        ...
        set: function (a, b, c) {
            return b === !1 ? m.removeAttr(a, c) : Gb && Fb || !Eb.test(c) ? a.setAttribute(!Fb && m.propFix[c] || c, c) : a[m.camelCase("default-" + c)] = a[c] = !0, c
        }
    }, m.each(m.expr.match.bool.source.match(/\w+/g), function (a, b) {
        var c = Db[b] || m.find.attr;
        Db[b] = Gb && Fb || !Eb.test(b) ? function (a, b, d) {
            var e, f;
            return d || (f = Db[b], Db[b] = e, e = null != c(a, b, d) ? b.toLowerCase() : null, Db[b] = f), e
        } : function (a, b, c) {
            return c ? void 0 : a[m.camelCase("default-" + b)] ? b.toLowerCase() : null
        }
    }), Gb && Fb || (m.attrHooks.value = {
        set: function (a, b, c) {
            return m.nodeName(a, "input") ? void(a.defaultValue = b) : Bb && Bb.set(a, b, c)
        }
    }), Fb || (Bb = {
        set: function (a, b, c) {
    ...
    }, Db.id = Db.name = Db.coords = function (a, b, c) {
        var d;
    ...
    m.fn.extend({
        prop: function (a, b) {
            return T(this, m.prop, a, b, arguments.length > 1)
        },
        ...
        propHooks: {
            tabIndex: {
                get: function (a) {
                    ...
                    return b ? parseInt(b, 10) : Hb.test(a.nodeName) || Ib.test(a.nodeName) && a.href ? 0 : -1
                }
            }
        }
        ...
        addClass: function (a) {
            ...
            if (j)
                for (b = (a || "").match(E) || []; i > h; h++)
                    if (c = this[h], d = 1 === c.nodeType && (c.className ? (" " + c.className + " ").replace(Jb, " ") : " ")) {
                        f = 0;
                ...
                v = {
                    ...
                    getResponseHeader: function (a) {
                        ...
                        if (2 === t) {
                            if (!j) {
                                j = {};
                                while (b = Rb.exec(f)) j[b[1].toLowerCase()] = b[2]
                            }
                            b = j[a.toLowerCase()]
                        }
    ...
    m.ajaxSetup({
        ...
        var e, f, g, h = b.jsonp !== !1 && (pc.test(b.url) ? "url" : "string" == typeof b.data && !(b.contentType || "").indexOf("application/x-www-form-urlencoded") && pc.test(b.data) && "data");
